...
class BLEController {
   public:
    /**
     * @brief Constructs a BLEController object with the specified parameters.
     *
   ...
   private:
    ...
    class MyServerCallbacks : public BLEServerCallbacks {
       public:
         ...
         *
         * @param BLEController Pointer to the BLEController object.
         */
        MyServerCallbacks(BLEController* BLEController) : _bleControl(BLEController) {}
       ...
       private:
        BLEController* _bleControl;  ///< Pointer to the BLEController object.
    };
    ...
    class MyCharacteristicCallbacks : public BLECharacteristicCallbacks {
       public:
         ...
         * @param BLEController Pointer to the BLEController object.
         */
        MyCharacteristicCallbacks(BLEController* BLEController) : _bleControl(BLEController) {}
